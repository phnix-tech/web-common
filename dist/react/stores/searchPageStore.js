...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "react", "./createStore", "../components/withStore"], factory);
    }
    ...
    var withStore_1 = __importDefault(require("../components/withStore"));
    var ActionType;
    (function (ActionType) {
     ...
     */
    function default_1(searchParams, extraState, ctx) {
        ...
        var context = react_1.default.createContext(ctx);
        ...
        function createStore() {
            return createStore_1.default(reducer, INIT_STATE);
        }
        ...
        function withStore(Component) {
            return withStore_1.default(Component, { createStore: createStore, context: context });
        }
        return {
            context: context,
